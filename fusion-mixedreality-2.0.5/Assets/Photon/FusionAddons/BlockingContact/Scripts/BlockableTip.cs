...
namespace Fusion.Addons.BlockingContact
{
    ...
    public class BlockableTip : NetworkBehaviour
    {
        ...
        {
            if (feedback && previousSurfaceInContact && other.gameObject == previousSurfaceInContact.gameObject)
            {
        ...
        public override void Render()
        {
            ...
            if (feedback && IsGrabbed && IsInContact && string.IsNullOrEmpty(audioType) == false)
            {
